function fgplvmPrecompVisualise(model, varsigma, visualiseFunction, visualiseModify, varargin)
global visualiseInfo

% figure(1)
% clf
[visualiseInfo.plotAxes visualiseInfo.dataProb] = fgplvmPrecompScatterPlot(model, varsigma);
...
% visualiseInfo.visualiseReevaluate = str2func(visualiseReevaluate);
