...
%	Description:
%
%	G = GPDYNAMICSLOGLIKEGRADIENTS(MODEL) Computes the gradients with
%	respect to the log likelihood of the GP dynamics in a GP-LVM model.
%	 Returns:
...
%
%	See also
%	GPLOGLIKEGRADIENTS, GPDYNAMICSCREATE, GPDYNAMICSLOGLIKELIHOOD, MODELLOGLIKELIHOOD


%	Copyright (c) 2006, 2009 Neil D. Lawrence


%	With modifications by Carl Henrik Ek 2006
% 	gpDynamicsLogLikeGradients.m CVS version 1.5
% 	gpDynamicsLogLikeGradients.m SVN version 178
% 	last update 2009-01-08T13:59:20.000000Z
