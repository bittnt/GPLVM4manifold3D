function [x, pointlog, options, flog] = conjgrad(f, x, options, gradf, ...
    writef, writef3d, startIdx, varargin)
...
%         end
    ...
    feval(writef, pointlog(j, :), varargin{1}, varargin{2}, startIdx - 2 + j);
    feval(writef3d, pointlog(j, :), varargin{1}, varargin{2}, startIdx - 2 + j);
end
